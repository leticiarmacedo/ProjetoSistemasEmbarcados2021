...
execute_process(
  COMMAND "/usr/bin/git" show-ref v19.18
  WORKING_DIRECTORY "/home/pi/Desktop/Aulas/OpenCV/matrix/Build/_deps/dlib-src"
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v19.18
  WORKING_DIRECTORY "/home/pi/Desktop/Aulas/OpenCV/matrix/Build/_deps/dlib-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/pi/Desktop/Aulas/OpenCV/matrix/Build/_deps/dlib-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/pi/Desktop/Aulas/OpenCV/matrix/Build/_deps/dlib-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
